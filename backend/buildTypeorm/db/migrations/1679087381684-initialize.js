export class initialize1679087381684 {
    name = 'initialize1679087381684';
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "experience" ("id" SERIAL NOT NULL, "title" text NOT NULL, "experience" text NOT NULL, "sub" text NOT NULL, "date" date NOT NULL, "image" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "userId" integer, CONSTRAINT "PK_5e8d5a534100e1b17ee2efa429a" PRIMARY KEY ("id"))`);
...
//# sourceMappingURL=1679087381684-initialize.js.map