export class initialize1679096580276 {
    name = 'initialize1679096580276';
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "email" text NOT NULL, "sub" text NOT NULL, "password" text NOT NULL DEFAULT '$2b$04$n3u8uyu6.vkablnBXQCqVe8wiFqaC9uDZzifeRUBhgO3FujMyvR9G', "badwords" integer NOT NULL DEFAULT '0', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
...
//# sourceMappingURL=1679096580276-initialize.js.map